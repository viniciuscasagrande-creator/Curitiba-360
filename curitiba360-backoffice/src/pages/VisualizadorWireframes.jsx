...
export default function VisualizadorWireframes() {
  ...
  const portalDesktopWireframes = [
    { code: 'WF-001', name: 'Portal - Tela de login', route: '/portal/login', img: '/wireframes-portal/WF-001 - Tela de login.png' },
    { code: 'WF-001A', name: 'Portal - Recuperar Senha', route: '/portal/recuperar-senha', img: '/wireframes-portal/WF-001A - Recuperar Senha.png' },
    { code: 'WF-001B', name: 'Portal - Email Recuperar Senha', route: '/portal/email-recuperar-senha', img: '/wireframes-portal/WF-001B - Email Recuperar Senha.png' },
    { code: 'WF-001C', name: 'Portal - Criar Nova Senha', route: '/portal/criar-senha', img: '/wireframes-portal/WF-001C - Recuperar Senha Criar senha.png' },
    { code: 'WF-002', name: 'Portal - Página Inicial', route: '/portal', img: '/wireframes-portal/WF-002 - Página Inicial.png' },
    { code: 'WF-002B', name: 'Portal - Página Inicial dropdown perfil', route: '/portal', img: '/wireframes-portal/WF-002B - Página Inicial dropdown perfil.png' },
    { code: 'WF-003', name: 'Portal - Criar conta', route: '/portal/criar-conta', img: '/wireframes-portal/WF-003- Criar conta.png' },
    { code: 'WF-003A', name: 'Portal - Email Confirmação de Cadastro', route: '/portal/email-confirmacao', img: '/wireframes-portal/WF-003A - Email Confirmação de Cadastro.png' },
    { code: 'WF-003B', name: 'Portal - Confirmação de Cadastro', route: '/portal/confirmacao-cadastro', img: '/wireframes-portal/WF-003B - Confirmação de Cadastro.png' },
    { code: 'WF-004', name: 'Portal - Cadastro de Parceiro Comercial', route: '/portal', img: '/wireframes-portal/WF-004 - Cadastro de Parceiro Comercial.png' },
    { code: 'WF-004A', name: 'Portal - Cadastro de Agência', route: '/portal', img: '/wireframes-portal/WF-004A - Cadastro de Agência.png' },
    { code: 'WF-004A-C', name: 'Portal - Auto-cadastro Agência - Conclusão', route: '/portal', img: '/wireframes-portal/WF-004A - Auto-cadastro Agência — Conclusão.png' },
    { code: 'WF-004B-E1', name: 'Portal - Auto-cadastro Parceiro - Etapa 1', route: '/portal', img: '/wireframes-portal/WF-004B - Auto-cadastro Parceiro Comercial — Etapa 1 (Dados da Empresa).png' },
    { code: 'WF-004B-E2', name: 'Portal - Auto-cadastro Parceiro - Etapa 2', route: '/portal', img: '/wireframes-portal/WF-004B - Auto-cadastro Parceiro Comercial — Etapa 2 (Dados do Responsável).png' },
    { code: 'WF-004B-E3', name: 'Portal - Auto-cadastro Parceiro - Etapa 3', route: '/portal', img: '/wireframes-portal/WF-004B - Auto-cadastro Parceiro Comercial — Etapa 3 (Documentos e Informações Complementares).png' },
    { code: 'WF-004B-C', name: 'Portal - Auto-cadastro Parceiro - Conclusão', route: '/portal', img: '/wireframes-portal/WF-004B - Auto-cadastro Parceiro Comercial — Conclusão (Solicitação enviada).png' },
    { code: 'WF-005', name: 'Portal - Resultados da Pesquisa', route: '/portal', img: '/wireframes-portal/WF-005 - Resultados da Pesquisa.png' },
    { code: 'WF-006', name: 'Portal - Pacotes de atrações', route: '/portal', img: '/wireframes-portal/WF-006 - Pacotes de atrações.png' },
    { code: 'WF-007', name: 'Portal - Conhecendo Curitiba', route: '/portal', img: '/wireframes-portal/WF-007 - Conhecendo Curitiba.png' },
    { code: 'WF-008', name: 'Portal - Detalhes da Atração', route: '/portal', img: '/wireframes-portal/WF-008 - Detalhes da Atração.png' },
    { code: 'WF-0080C', name: 'Portal - Detalhes da Atração exibir imagem', route: '/portal', img: '/wireframes-portal/WF-0080C - Detalhes da Atração exibir imagem.png' },
    { code: 'WF-008A', name: 'Portal - Detalhes da Atração adicionado ao carrinho', route: '/portal', img: '/wireframes-portal/WF-008A - Detalhes da Atração adicionado ao carrinho.png' },
    { code: 'WF-008B', name: 'Portal - Detalhes da Atração pedido de login', route: '/portal', img: '/wireframes-portal/WF-008B - Detalhes da Atração pedido de login.png' },
    { code: 'WF-008D', name: 'Portal - Detalhes da Atração exibir imagem galeria', route: '/portal', img: '/wireframes-portal/WF-008D - Detalhes da Atração exibir imagem galeria.png' },
    { code: 'WF-010', name: 'Portal - Carrinho de Compras', route: '/portal', img: '/wireframes-portal/WF-010 - Carrinho.png' },
    { code: 'WF-011', name: 'Portal - Pedido (Checkout)', route: '/portal', img: '/wireframes-portal/WF-011 - Pedido.png' },
    { code: 'WF-012', name: 'Portal - Pagamento Cartão', route: '/portal', img: '/wireframes-portal/WF-012 - Pagamento Cartão.png' },
    { code: 'WF-012A', name: 'Portal - Pagamento Google Pay', route: '/portal', img: '/wireframes-portal/WF-012A - Pagamento Google Pay.png' },
    { code: 'WF-012B', name: 'Portal - Pagamento Pix', route: '/portal', img: '/wireframes-portal/WF-012B - Pagamento Pix.png' },
    { code: 'WF-013', name: 'Portal - Pagamento Confirmado', route: '/portal', img: '/wireframes-portal/WF-013 - Pagamento Confirmado.png' },
    { code: 'WF-013A', name: 'Portal - Email Pagamento Confirmado', route: '/portal/email-confirmacao', img: '/wireframes-portal/WF-013A - Email Pagamento Confirmado.png' },
    { code: 'WF-014', name: 'Portal - Meus ingressos', route: '/portal', img: '/wireframes-portal/WF-014 - Meus ingressos.png' },
    { code: 'WF-014A', name: 'Portal - Meus ingressos resumo do pedido', route: '/portal', img: '/wireframes-portal/WF-014A - Meus ingressos resumo do pedido.png' },
    { code: 'WF-014B', name: 'Portal - Meus ingressos ver no mapa', route: '/portal', img: '/wireframes-portal/WF-014B - Meus ingressos ver no mapa.png' },
    { code: 'WF-015', name: 'Portal - Configurações dados pessoais', route: '/portal', img: '/wireframes-portal/WF-015 - Configurações dados pessoais.png' },
    { code: 'WF-015A', name: 'Portal - Configurações notificações', route: '/portal', img: '/wireframes-portal/WF-015A - Configurações notificações.png' },
    { code: 'WF-015B', name: 'Portal - Configurações Cartões Salvos', route: '/portal', img: '/wireframes-portal/WF-015B - Configurações Cartões Salvos.png' },
    { code: 'WF-015C', name: 'Portal - Notificações (Inbox)', route: '/portal', img: '/wireframes-portal/WF-015C - Notificações.png' },
    { code: 'WF-016', name: 'Portal - Solicitação de Reembolso', route: '/portal', img: '/wireframes-portal/WF-016 - Solicitação de Reembolso.png' },
    { code: 'WF-016A', name: 'Portal - Email Confirmação de Reembolso', route: '/portal', img: '/wireframes-portal/WF-016A - Email Confirmacao de Reembolso.png' },
    { code: 'WF-016B', name: 'Portal - E-mail de Rejeição de Reembolso', route: '/portal', img: '/wireframes-portal/WF-016B - E-mail de Rejeição de Reembolso.png' },
    { code: 'WF-017', name: 'Portal - Política de Privacidade', route: '/portal', img: '/wireframes-portal/WF-017 - Política de Privacidade.png' },
    { code: 'WF-018', name: 'Portal - Condições de uso do site', route: '/portal', img: '/wireframes-portal/WF-018 - Condições de uso do site.png' },
    { code: 'WF-019', name: 'Portal - FAQ - Perguntas frequentes', route: '/portal', img: '/wireframes-portal/WF-019 - FAQ - Perguntas frequentes.png' },
    { code: 'WF-020', name: 'Portal - Sobre Nós', route: '/portal', img: '/wireframes-portal/WF-020 - Sobre Nós.png' },
    { code: 'WF-021-V', name: 'Portal - Meus Favoritos — Estado Vazio', route: '/portal', img: '/wireframes-portal/WF-021 - Meus Favoritos — Estado Vazio.png' },
    { code: 'WF-021', name: 'Portal - Meus Favoritos', route: '/portal', img: '/wireframes-portal/WF-021 - Meus Favoritos.png' },
    { code: 'WF-022-S1', name: 'Portal - Transferência de Ingresso — Estado 1', route: '/portal', img: '/wireframes-portal/WF-022 - Transferência de Ingresso — Estado 1.png' },
    { code: 'WF-022-S2', name: 'Portal - Transferência de Ingresso — Estado 2', route: '/portal', img: '/wireframes-portal/WF-022 - Transferência de Ingresso — Estado 2.png' },
    { code: 'WF-022-S3', name: 'Portal - Transferência de Ingresso — Estado 3', route: '/portal', img: '/wireframes-portal/WF-022 - Transferência de Ingresso — Estado 3.png' }
  ];

  // 3. Public Portal - Smartphone (Mobile) Wireframes
  const portalMobileWireframes = [
    { code: 'MWF-001', name: 'Mobile - Tela de login', route: '/portal/login', img: '/wireframes-portal/Mobile WF-001 - Tela de login.png' },
    { code: 'MWF-001A', name: 'Mobile - Recuperar Senha', route: '/portal/recuperar-senha', img: '/wireframes-portal/Mobile WF-001A - Recuperar Senha.png' },
    { code: 'MWF-001B', name: 'Mobile - Email Recuperar Senha', route: '/portal/email-recuperar-senha', img: '/wireframes-portal/Mobile WF-001B - Email Recuperar Senha.png' },
    { code: 'MWF-001C', name: 'Mobile - Criar Nova Senha', route: '/portal/criar-senha', img: '/wireframes-portal/Mobile WF-001C - Recuperar Senha Criar senha.png' },
    { code: 'MWF-002', name: 'Mobile - Página Inicial', route: '/portal', img: '/wireframes-portal/Mobile WF-002 - Página Inicial.png' },
    { code: 'MWF-003', name: 'Mobile - Criar conta', route: '/portal/criar-conta', img: '/wireframes-portal/Mobile WF-003- Criar conta.png' },
    { code: 'MWF-003A', name: 'Mobile - Email Confirmação de Cadastro', route: '/portal/email-confirmacao', img: '/wireframes-portal/Mobile WF-003A - Email Confirmação de Cadastro.png' },
    { code: 'MWF-003B', name: 'Mobile - Confirmação de Cadastro', route: '/portal/confirmacao-cadastro', img: '/wireframes-portal/Mobile WF-003B - Confirmação de Cadastro.png' },
    { code: 'MWF-004', name: 'Mobile - Cadastro de Parceiro', route: '/portal', img: '/wireframes-portal/Mobile WF-004 - Cadastro de Parceiro Comercial.png' },
    { code: 'MWF-005', name: 'Mobile - Resultados da Pesquisa', route: '/portal', img: '/wireframes-portal/Mobile WF-005 - Resultados da Pesquisa.png' },
    { code: 'MWF-007', name: 'Mobile - Conhecendo Curitiba', route: '/portal', img: '/wireframes-portal/Mobile WF-007 - Conhecendo Curitiba.png' },
    { code: 'MWF-008', name: 'Mobile - Detalhes da Atração', route: '/portal', img: '/wireframes-portal/Mobile WF-008 - Detalhes da Atração.png' },
    { code: 'MWF-0080C', name: 'Mobile - Detalhes da Atração exibir imagem', route: '/portal', img: '/wireframes-portal/Mobile WF-0080C - Detalhes da Atração exibir imagem.png' },
    { code: 'MWF-008B', name: 'Mobile - Detalhes da Atração pedido de login', route: '/portal', img: '/wireframes-portal/Mobile WF-008B - Detalhes da Atração pedido de login.png' },
    { code: 'MWF-008D', name: 'Mobile - Detalhes da Atração exibir imagem galeria', route: '/portal', img: '/wireframes-portal/Mobile WF-008D - Detalhes da Atração exibir imagem galeria.png' },
    { code: 'MWF-010', name: 'Mobile - Carrinho', route: '/portal', img: '/wireframes-portal/Mobile WF-010 - Carrinho.png' },
    { code: 'MWF-011', name: 'Mobile - Pedido', route: '/portal', img: '/wireframes-portal/Mobile WF-011 - Pedido.png' },
    { code: 'MWF-012', name: 'Mobile - Pagamento Cartão', route: '/portal', img: '/wireframes-portal/Mobile WF-012 - Pagamento Cartão.png' },
    { code: 'MWF-012A', name: 'Mobile - Pagamento Google Pay', route: '/portal', img: '/wireframes-portal/Mobile WF-012A - Pagamento Google Pay.png' },
    { code: 'MWF-012B', name: 'Mobile - Pagamento Pix', route: '/portal', img: '/wireframes-portal/Mobile WF-012B - Pagamento Pix.png' },
    { code: 'MWF-013', name: 'Mobile - Pagamento Confirmado', route: '/portal', img: '/wireframes-portal/Mobile WF-013 - Pagamento Confirmado.png' },
    { code: 'MWF-013A', name: 'Mobile - Email Pagamento Confirmado', route: '/portal/email-confirmacao', img: '/wireframes-portal/Mobile WF-013A - Pagamento Confirmado.png' },
    { code: 'MWF-014', name: 'Mobile - Meus ingressos', route: '/portal', img: '/wireframes-portal/Mobile WF-014 - Meus ingressos.png' },
    { code: 'MWF-014A', name: 'Mobile - Meus ingressos resumo do pedido', route: '/portal', img: '/wireframes-portal/Mobile WF-014A - Meus ingressos resumo do pedido.png' },
    { code: 'MWF-014B', name: 'Mobile - Meus ingressos ver no mapa', route: '/portal', img: '/wireframes-portal/Mobile WF-014B - Meus ingressos ver no mapa.png' },
    { code: 'MWF-015', name: 'Mobile - Configurações dados pessoais', route: '/portal', img: '/wireframes-portal/Mobile WF-015 - Configurações dados pessoais.png' },
    { code: 'MWF-015A', name: 'Mobile - Configurações notificações', route: '/portal', img: '/wireframes-portal/Mobile WF-015A - Configurações notificações.png' },
    { code: 'MWF-015B', name: 'Mobile - Configurações Cartões Salvos', route: '/portal', img: '/wireframes-portal/Mobile WF-015B - Configurações Cartões Salvos.png' },
    { code: 'MWF-015C', name: 'Mobile - Notificações (Inbox)', route: '/portal', img: '/wireframes-portal/Mobile WF-015C - Notificações.png' },
    { code: 'MWF-016', name: 'Mobile - Solicitação de Reembolso', route: '/portal', img: '/wireframes-portal/Mobile WF-016 - Solicitação de Reembolso.png' },
    { code: 'MWF-016A', name: 'Mobile - Email Confirmação de Reembolso', route: '/portal', img: '/wireframes-portal/Mobile WF-016A - Email Confirmacao de Reembolso.png' },
    { code: 'MWF-017', name: 'Mobile - Política de Privacidade', route: '/portal', img: '/wireframes-portal/Mobile WF-017 - Política de Privacidade.png' },
    { code: 'MWF-018', name: 'Mobile - Condições de uso do site', route: '/portal', img: '/wireframes-portal/Mobile WF-018 - Condições de uso do site.png' },
    { code: 'MWF-019', name: 'Mobile - FAQ - Perguntas frequentes', route: '/portal', img: '/wireframes-portal/Mobile WF-019 - FAQ - Perguntas frequentes.png' },
    { code: 'MWF-020', name: 'Mobile - Sobre Nós', route: '/portal', img: '/wireframes-portal/Mobile WF-020 - Sobre Nós.png' }
  ];
