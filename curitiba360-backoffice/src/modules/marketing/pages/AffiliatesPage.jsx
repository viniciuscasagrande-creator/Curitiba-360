    ...
    <PartnerLayout>
      <div className="mx-auto max-w-4xl space-y-6 select-none text-left">
        ...
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-sm text-slate-655 my-0">Convide parceiros ou influenciadores locais para divulgar seus ingressos em troca de comissões fixas ou percentuais.</p>
        </section>
      </div>
    </PartnerLayout>
  );
