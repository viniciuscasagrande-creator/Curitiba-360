        ...
        <header className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="mt-1 text-2xl font-bold tracking-tight text-slate-955 my-0">
              Integrações de Mensuração
            </h1>
          </div>
        </header>
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-sm text-slate-655 my-0">Adicione suas chaves do Google Analytics 4, Google Tag Manager, Meta Pixel e API de Conversões.</p>
        </section>
      </div>
    </PartnerLayout>
  );
