        ...
        <header className="flex items-center gap-4">
          ...
          <div>
            ...
            <h1 className="mt-1 text-2xl font-bold tracking-tight text-slate-955 my-0">
              Relatório de Desempenho de ROI
            </h1>
          </div>
        </header>
        <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          <p className="text-sm text-slate-655 my-0">Analise investimento, conversões atribuídas, custo por aquisição (CPA) e retorno de ROAS.</p>
        </section>
      </div>
    </PartnerLayout>
  );
