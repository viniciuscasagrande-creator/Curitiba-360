...
export default function CommissionReportFilters({
  filters,
  sellerOptions,
  agencyOptions,
  channelOptions,
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-xs font-medium text-slate-500">
            Consulte as comissões por período, vendedor,
            agência e canal de venda.
          </p>
        </div>
        ...
        <label className="block md:col-span-2 text-left">
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="Pesquisar vendedor ou agência"
              onChange={(event) =>
                updateFilter(
                  'search',
                  event.target.value,
