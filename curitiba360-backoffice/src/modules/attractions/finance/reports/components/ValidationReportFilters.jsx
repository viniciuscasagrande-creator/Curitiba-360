...
export default function ValidationReportFilters({
  filters,
  statusOptions,
  categoryOptions,
  gateOptions,
  ...
  return (
    <section className="mt-6 rounded-[24px] border border-slate-200 bg-white p-5 shadow-sm print:hidden text-left">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
          ...
          <p className="mt-1 text-xs font-medium text-slate-500">
            Consulte as leituras e tentativas de validação dos ingressos.
          </p>
        </div>
      ...
      <div className="mt-5 grid gap-4 md:grid-cols-2 xl:grid-cols-4">
        ...
        <label className="block md:col-span-2 xl:col-span-1 text-left">
          <span className={labelClass}>
            Ingresso, pedido ou cliente
          </span>
