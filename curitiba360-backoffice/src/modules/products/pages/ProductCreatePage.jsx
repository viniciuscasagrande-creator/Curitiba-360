...
export default function ProductCreatePage() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      window.alert("Produto criado como rascunho com sucesso!");
        ...
        <header className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-slate-505 my-0">
              Preencha os campos abaixo para criar uma atração, evento ou passeio.
            </p>
          </div>
        </header>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-6">
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              />
              {errors.title && <p className="mt-1 text-xs text-red-650 my-0">{errors.title.message}</p>}
            </div>
            ...
            <div>
              ...
              {errors.category && <p className="mt-1 text-xs text-red-650 my-0">{errors.category.message}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="h-11 w-full rounded-xl border border-slate-200 px-4 text-sm font-semibold outline-none focus:border-emerald-500 bg-white transition"
              />
              {errors.basePrice && <p className="mt-1 text-xs text-red-650 my-0">{errors.basePrice.message}</p>}
            </div>
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="h-11 w-full rounded-xl border border-slate-200 px-4 text-sm font-semibold outline-none focus:border-emerald-500 bg-white transition"
            />
            {errors.shortDescription && <p className="mt-1 text-xs text-red-650 my-0">{errors.shortDescription.message}</p>}
          </div>
          ...
          <div>
            ...
            />
            {errors.description && <p className="mt-1 text-xs text-red-650 my-0">{errors.description.message}</p>}
          </div>
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div>
              ...
              <input
                ...
                className="h-11 w-full rounded-xl border border-slate-200 px-4 text-sm font-semibold outline-none focus:border-emerald-500 bg-white transition"
              />
              {errors.maxCapacity && <p className="mt-1 text-xs text-red-650 my-0">{errors.maxCapacity.message}</p>}
            </div>
            ...
            <div>
              ...
              <input
                ...
                className="h-11 w-full rounded-xl border border-slate-200 px-4 text-sm font-semibold outline-none focus:border-emerald-500 bg-white transition"
              />
              {errors.limitPerCPF && <p className="mt-1 text-xs text-red-650 my-0">{errors.limitPerCPF.message}</p>}
            </div>
          </div>
