...
import { attractionStatusLabels, operationTypeLabels } from '../data/attractionsMock';
                ...
                >
                    ...
                    >
                      ...
                      <div>
                        ...
                        <span className="text-xs text-slate-500 font-medium flex items-center gap-1">
                          ...
                          {attraction.location?.city || 'Curitiba'}, {attraction.location?.state || 'PR'}
                        </span>
                      </div>
                    </button>
                  </td>
                  ...
                  <td className="px-4 py-4 text-xs font-medium text-slate-600">
                    <span className="rounded-lg bg-slate-100 px-2.5 py-1 text-[11px] font-bold text-slate-700">
                      {operationTypeLabels[attraction.operationType] || attraction.operationType}
                    </span>
                  </td>

                  <td className="px-4 py-4 text-xs text-slate-500 font-medium">
                    {new Intl.DateTimeFormat('pt-BR').format(new Date(attraction.createdAt))}
                  </td>
                  ...
                  <td className="px-4 py-4">
                    <span
                      className={[
                        ...
                        statusStyles[attraction.status] || statusStyles.active
                      ].join(' ')}
                    >
                      {attractionStatusLabels[attraction.status] || attraction.status}
                    </span>
                  </td>
      ...
      {attractions.length === 0 && (
        <div className="px-6 py-16 text-center">
          ...
          <p className="mt-2 text-sm text-slate-500 font-medium">
            Tente mudar a pesquisa ou adicione uma nova atração.
          </p>
        </div>
      )}
