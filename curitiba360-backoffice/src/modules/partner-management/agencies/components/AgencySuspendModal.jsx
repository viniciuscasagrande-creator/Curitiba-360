...
export default function AgencySuspendModal({ agency, onClose, onConfirm }) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-xs p-4 animate-in fade-in">
      <div className="w-full max-w-md rounded-[24px] border border-rose-200 bg-white p-6 shadow-2xl text-left space-y-4">
        ...
        <p className="text-xs font-medium text-slate-600">
          Você está suspendendo a agência <strong className="text-slate-900">{agency.tradeName}</strong>. Esta ação desabilitará o acesso de todos os agentes vinculados.
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <textarea
              ...
              placeholder="Ex.: Inadimplência ou descumprimento contratual..."
