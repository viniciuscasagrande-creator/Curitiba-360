...
export default function PushNotificationsScreen() {
  ...
  useEffect(() => {
    communicationService.getCommunicationOverview().then((res) => {
  ...
  if (loading || !data) {
    return (
      <div className="bg-slate-900 min-h-screen p-12 text-center text-white space-y-3 flex flex-col items-center justify-center">
        ...
        <p className="text-xs text-purple-300 font-semibold animate-pulse">Carregando configurações de notificações...</p>
      </div>
    );
  }
