...
export default function FinancialChargebacksPage() {
      ...
      <div className="mx-auto max-w-4xl space-y-6 select-none text-left">
        ...
        {account && (
          <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm space-y-4">
            <h3 className="text-lg font-bold text-slate-955 my-0">Resumo de Contestações</h3>
            <div className="text-sm text-slate-700">
              <p className="my-0">
                <strong>Taxa de Chargeback cobrada:</strong> R$ {account.fees.chargeback.toFixed(2)}
              </p>
            </div>
          </section>
        )}
